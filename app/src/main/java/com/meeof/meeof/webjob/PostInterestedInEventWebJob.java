...
public class PostInterestedInEventWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = PostInterestedInEventWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/events/me/interest";
    private final String token;
    private final int eventId;


    public PostInterestedInEventWebJob(String token, int eventId) {
    ...
    public void onRun() throws Throwable {
        ...
        try {
            ...
            InterestedEventResponse httpResponseForAddFriend = null;
            try {
                ObjectMapper mapper = new ObjectMapper();
                httpResponseForAddFriend = mapper.readValue(result, InterestedEventResponse.class);
