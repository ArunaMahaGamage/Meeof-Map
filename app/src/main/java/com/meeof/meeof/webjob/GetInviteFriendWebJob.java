...
public class GetInviteFriendWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = "GetProfileWebJob";
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/meeof/invites";
    private final String token;
    private final String email;


    public GetInviteFriendWebJob(String token, String email) {
