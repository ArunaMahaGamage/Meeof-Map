...
public class SetReadPropertyWebJob extends Job {
    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = CancelEventWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/messages/notifications";
    private final String token;
    private int GroupId;
    public SetReadPropertyWebJob(String token, int GroupId) {
