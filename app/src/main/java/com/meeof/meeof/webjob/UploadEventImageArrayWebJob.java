...
public class UploadEventImageArrayWebJob extends Job {
    /**
    ...
    private static final String TAG = UploadEventImageArrayWebJob.class.getSimpleName();
    ...
    public UploadEventImageArrayWebJob(String accessToken, String[] path, int eventId) {
    ...
    public void onRun() throws Throwable {
        ...
        String response = uploadImages(url, files, accessToken, eventId);
        ...
        try {
            ...
            if (imageResponse != null) {
                if (imageResponse.getStatus().equals(Constant.SUCCESS)) {
                    ...
                    EventBus.getDefault().post(new EventImageUploadResponse(Constant.ERROR,null,null));
                }
            } else {
                EventBus.getDefault().post(new EventImageUploadResponse(null,null,null));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public String uploadImages(String url, File[] media, String token, int eventId) {
