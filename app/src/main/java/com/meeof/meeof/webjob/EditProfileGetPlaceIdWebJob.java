...
public class EditProfileGetPlaceIdWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = EditProfileGetPlaceIdWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private final double lat;
    private final double longi;


    public EditProfileGetPlaceIdWebJob(double lat, double longi) {
            ...
            try {
                ...
                if (result != null) {
                    ...
                    if (jsonObj.getString("status").equalsIgnoreCase(Constant.OK)) {
                        ...
                        EventBus.getDefault().post(new EditProfileGooglePlaceIdResponse(Constant.SUCCESS, resultsArr));
                    } else {
                        EventBus.getDefault().post(new EditProfileGooglePlaceIdResponse(Constant.ERROR, null));
                    }
                } else {
                    EventBus.getDefault().post(new EditProfileGooglePlaceIdResponse(Constant.ERROR, null));
                }
