...
public class PostEditUpdateWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = PostEditUpdateWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/updates";
    private final String token;
    private final PostEditUpdateModel postAddUpdateModel;


    public PostEditUpdateWebJob(String token, PostEditUpdateModel postAddUpdateModel) {
    ...
    public void onRun() throws Throwable {
        ...
        EditUpdateResponse addUpdateResponse = null;
        ...
        try {
            ...
            addUpdateResponse = mapper.readValue(response, EditUpdateResponse.class);
    ...
    private String setDetails(String url, PostEditUpdateModel postAddUpdateModel, String token) {
        try {
            ...
            MultipartBody.Builder buildernew = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("updateid", postAddUpdateModel.getUpdateid() + "")
