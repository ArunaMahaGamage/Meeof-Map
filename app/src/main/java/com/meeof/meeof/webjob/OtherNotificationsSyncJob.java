...
public class OtherNotificationsSyncJob extends Job {
    ...
    public OtherNotificationsSyncJob(String notifications) {
    ...
    public void onRun() throws Throwable {
        ...
        try {
            ...
            if(notifications != null){
                ...
                dbHelper.insertOrUpdateOtherNotification(eventsJson);
            }else{
