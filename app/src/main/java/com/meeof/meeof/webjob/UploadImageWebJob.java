...
public class UploadImageWebJob extends Job {
    /**
    ...
    private static final String TAG = UploadImageWebJob.class.getSimpleName();
    ...
    public UploadImageWebJob(String accessToken, String path) {
    ...
    public void onRun() throws Throwable {
        ...
        ImageUploadResponse imageResponse = null;
        ...
        try {
            ...
            imageResponse = mapper.readValue(response, ImageUploadResponse.class);
