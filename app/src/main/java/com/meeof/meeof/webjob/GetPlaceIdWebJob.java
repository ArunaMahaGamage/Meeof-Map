...
public class GetPlaceIdWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = GetPlaceIdWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private final double lat;
    private final double longi;


    public GetPlaceIdWebJob(double lat, double longi) {
            ...
            try {
                ...
                if (result != null) {
                    ...
                    if (jsonObj.getString("status").equalsIgnoreCase(Constant.OK)) {
                        ...
                        EventBus.getDefault().post(new GooglePlaceIdResponse(Constant.SUCCESS, resultsArr));
                    } else {
                        EventBus.getDefault().post(new GooglePlaceIdResponse(Constant.ERROR, null));
                    }
                } else {
                    EventBus.getDefault().post(new GooglePlaceIdResponse(Constant.ERROR, null));
                }
