...
public class PostLikeEventAsFriendWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = PostLikeEventAsFriendWebJob.class.getSimpleName();
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/events/like";
    private final String token;
    private final int eventId;


    public PostLikeEventAsFriendWebJob(String token, int eventId) {
...
//            Log.d(TAG, cropImageResponse.toString());
            ...
            EventBus.getDefault().post(new HttpResponseLikeUnlike(null, null));
        }
