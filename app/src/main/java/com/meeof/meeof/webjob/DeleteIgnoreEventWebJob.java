...
public class DeleteIgnoreEventWebJob extends Job {

    public static final int PRIORITY = 1;
    private final int id;
    private static final String TAG = "DeleteFriendWebJob";
    private static final AtomicInteger jobCounter = new AtomicInteger(0);
    private static final String endPoint = "/api/user/events/ignored/delete?event_id=";
    private final String token;
    private final String eventId;

    public DeleteIgnoreEventWebJob(String token, String eventId) {
    ...
    public void onRun() throws Throwable {
        ...
        try {
            ...
            Log.d(TAG, "DeleteIgnoreEventWebJob response: " + result);
