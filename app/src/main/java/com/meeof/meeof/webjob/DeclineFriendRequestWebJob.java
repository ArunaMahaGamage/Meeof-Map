...
public class DeclineFriendRequestWebJob extends Job {
    ...
    public DeclineFriendRequestWebJob(String token, int userId, boolean isAccept) {
...
//                    .build();
            ...
            HttpDeclineFriendResponse acceptDecResponse = null;
            try {
                ObjectMapper mapper = new ObjectMapper();
                acceptDecResponse = mapper.readValue(result, HttpDeclineFriendResponse.class);
