...
public class OtherNotificationFragment extends BaseFragment implements View.OnClickListener, VpLifeCycleManager, SwipeRefreshLayout.OnRefreshListener {


private static final String TAG = OtherNotificationFragment.class.getSimpleName();
private static final int RC_REFRESH_LIST = 5672;

private String accessToken;
private int currentOtherNotificationsCount = 0;
private SharedPreferences sharedPreferences;
private RecyclerView privateInvitaionRv;
public NotificationRecyclerAdapter showNotificationsRecyclerAdapter;
private SwipeRefreshLayout otherNotificationsSRL;
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    private void initViews(View view) {
        ...
        otherNotificationsSRL = (SwipeRefreshLayout) view.findViewById(R.id.myEventsSRL);
        int mycolor = Color.parseColor("#7d9fb7");
        otherNotificationsSRL.setColorSchemeColors(mycolor);

        otherNotificationsSRL.setOnRefreshListener(this);
    }
    ...
    private void setDataToListEvents(final List<NotificationsData> events) {
        broadcastMyEventTabUpdate(currentOtherNotificationsCount);
        currentOtherNotificationsCount = 0;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (requestCode == RC_REFRESH_LIST) {
                ...
                new OtherNotificationFragment.FetchEventDataAsync().execute("params");
            }
        }
    }

    private void showPopUpMenu(final boolean isHost, View anchor, final Event event) {
        final android.support.v7.widget.PopupMenu popup = new android.support.v7.widget.PopupMenu(getActivity(), anchor);
...
//        if(otherNotificationsSRL != null){
//            getActivity().runOnUiThread(new Runnable() {
//                @Override
//                public void run() {
//                    otherNotificationsSRL.setRefreshing(true);
//                }
//            });
//        }
    }
    ...
    private class FetchEventDataAsync extends AsyncTask<String, Void, List<NotificationsData>> {
        ...
        protected List<NotificationsData> doInBackground(String... params) {
            ...
            try {
                ...
                eventData = dbHelper.getAllOtherNotifications();
        ...
        protected void onPostExecute(List<NotificationsData> eventData) {
            ...
            if(otherNotificationsSRL != null){
                otherNotificationsSRL.setRefreshing(false);
            }
            stopProgressBar();
            if (eventData != null) {
    ...
    public void onResumeFragment() {
        ...
        currentOtherNotificationsCount = sharedPreferences.getInt(Constant.IMPORTANT_NOTIFICATIONS_BADGE_COUNT, 0);
        ...
        fetchEventDataAsync = new OtherNotificationFragment.FetchEventDataAsync().execute("params");
    }
    ...
    public void onDeleteEventWebJob(DeleteNotificationWebJobResponse deleteNotificationWebJobResponse) {
        ...
        if (deleteNotificationWebJobResponse != null) {
            if (deleteNotificationWebJobResponse.getStatus() != null && deleteNotificationWebJobResponse.getStatus().equals(Constant.SUCCESS)) {
                ...
                dbHelper.deleteAllOtherNotifications();
                jobManager.addJobInBackground(new GetOtherNotificationsJob(accessToken));
            } else {
