 ...
 */
public class NotGoingFriendsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = NotGoingFriendsRecyclerAdapter.class.getSimpleName();
    private final Context mContext;
    private List<AttendeeList> notgoingList;
    ...
    public NotGoingFriendsRecyclerAdapter(Context context, List<AttendeeList> notgoingList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final AttendeeList item = notgoingList.get(position);
        ...
        myViewHolderParcel.friend_status_imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onClick.onItemClick(position, notgoingList.get(position), myViewHolderParcel);
    ...
    public int getItemCount() {
        return (null != notgoingList ? notgoingList.size() : notgoingList.size());
    }
