 ...
 */
public class MeeofUserSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = MeeofUserSearchAdapter.class.getSimpleName();
    ...
    public MeeofUserSearchAdapter(Context context, List<Data> listItems) {
...
//        this.filterList.addAll(this.listItem); //to show all items at begining
    ...
    public void updateList(List<Data> listItems){
        this.listItem = listItems;
