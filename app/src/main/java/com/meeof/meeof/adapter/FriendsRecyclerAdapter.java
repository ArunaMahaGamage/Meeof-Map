...
public class FriendsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<FriendListItem> listItem, filterList;
...
//    private final ViewBinderHelper viewBinderHelper = new ViewBinderHelper();
    ...
    public FriendsRecyclerAdapter(Context context, List<FriendListItem> listItems) {
        this.listItem = listItems;
        this.mContext = context;
        this.filterList = new ArrayList<FriendListItem>();
...
//                .inflate(R.layout.item_friend_deletable, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        final FriendListItem item = filterList.get(position);

        final MyViewHolderFriend myViewHolderParcel = (MyViewHolderFriend) holder;
        myViewHolderParcel.friend_name_textView.setText(item.getName());
...
//        myViewHolderParcel.friend_imageView.setText(item.getStatus());
        ...
        if (item.getStatus().equals("active")) {
            ...
            Log.d(TAG,"Inside elif dummy green");
            Log.d(TAG,"Inside elif dummy green friend: " + item.getFriend_status());
            statusDrawable = ContextCompat.getDrawable(mContext, R.drawable.ico_status_pending);
            myViewHolderParcel.friend_status_textView.setText("Invite Friend to Join Meeof");
        } else {
...
//        return listItem.size();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (TextUtils.isEmpty(text)) {
                    ...
                    for (FriendListItem item : listItem) {
    ...
    public List<FriendListItem> getFilteredList() {
        return filterList;
    }
