...
public class PlaceAutocompleteListAdapter extends RecyclerView.Adapter<PlaceAutocompleteListAdapter.PlaceViewHolder> implements Filterable {
    ...
    private static final String TAG = PlaceAutocompleteListAdapter.class.getSimpleName();
    ...
    public PlaceAutocompleteListAdapter(Context context, int resource, GoogleApiClient googleApiClient,
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    if (mResultList != null) {
                        ...
                        for (PlaceAutocomplete str :
                                mResultList) {
                            Log.d(TAG,str.description.toString());
...
//                        Toast.LENGTH_SHORT).show();
    ...
    public void onBindViewHolder(PlaceViewHolder mPredictionHolder, final int i) {
        Log.d(TAG,"Data:"+mResultList.get(i).description.toString());
        Log.d(TAG,"DataSize :"+mResultList.size());
        Log.d(TAG,"DataSize :"+mResultList.get(i).description.toString());
