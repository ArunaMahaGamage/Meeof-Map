 ...
 */
public class PhotosEventFullScreenRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = PhotosEventFullScreenRecyclerAdapter.class.getSimpleName();
    ...
    public PhotosEventFullScreenRecyclerAdapter(Context context, List<Photos> listItems) {
...
//            userNameTv = (TextView) view.findViewById(R.id.userNameTv);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_event_image_fullscreen, parent, false);
...
//
        Picasso.with(mContext.getApplicationContext())
                ...
                .placeholder(R.drawable.ico_profile_edit_avatar)
                .error(ContextCompat.getDrawable(mContext, R.drawable.ico_profile_edit_avatar))
                .into(myViewHolderPendingFriend.userImagesIv);
//
//
