 ...
 */
public class ShowAllEventsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = ShowAllEventsRecyclerAdapter.class.getSimpleName();
    ...
    public ShowAllEventsRecyclerAdapter(Context context, List<Event> listItems) {
...
//                // myViewHolder.likeIv.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.like));
//                myViewHolder.likeIv.setVisibility(View.VISIBLE);
//                break;
//            } else {
//                Log.d(TAG, "item not liked!!!!!!! ");
//                //myViewHolder.likeIv.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.not_like_button));
//                myViewHolder.likeIv.setVisibility(View.INVISIBLE);
//                break;
//            }
//        }
...
//
//    }
    private ShowAllEventsRecyclerAdapter.onCommentClick onCommentClick;

    public interface onCommentClick {
        void onCommentItemClick(int position, Event item);
    }

    public void setOnCommentClick(ShowAllEventsRecyclerAdapter.onCommentClick onCommentClick) {
