...
public class BaseActivityPopup extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener {

    protected static final int RC_GOOGLE_SIGN_IN = 9001;
    protected static final int RC_FACEBOOk_SIGN_IN = 64206;
    private static final String TAG = BaseActivityPopup.class.getSimpleName();
